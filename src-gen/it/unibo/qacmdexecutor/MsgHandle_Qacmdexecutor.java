...
public class MsgHandle_Qacmdexecutor extends QActor implements IMsgQueue{ 
	protected AsynchActionResult aar = null;
	protected boolean actionResult = true;
	protected alice.tuprolog.SolveInfo sol;
  	protected Vector<QActorMessage> msgQueue = new Vector<QActorMessage>();

	public MsgHandle_Qacmdexecutor(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
	...
	//Called by MsgHandle_Qacmdexecutor_ctrl
