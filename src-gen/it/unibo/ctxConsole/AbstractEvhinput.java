...
public abstract class AbstractEvhinput extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhinput(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
...
//showMsg( "---------------------------------------------------------------------" );	
		QActorUtils.getQActor("robot_ctrl").addRule(event.getDefaultRep());
	}//handleCurrentEvent
