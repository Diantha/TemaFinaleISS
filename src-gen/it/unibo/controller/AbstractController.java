...
public abstract class AbstractController extends QActor implements IActivity{ 
	...
	protected void addCmdPanels(){
		...
		*/
	    ...
	    while(true){
	    nPlanIter++;
	    		temporaryStr = "\"Inizio controller \"";
	    ...
	    public boolean inizio() throws Exception{	//public to allow reflection
	    try{
	    	curPlanInExec =  "inizio";
	    	boolean returnValue = suspendWork;
	    while(true){
	    nPlanIter++;
	    		parg = "actorOp(inizializzazione)";
	    ...
	    return returnValue;
	       ...
	       //println( getName() + " plan=inizio WARNING:" + e.getMessage() );
	       QActorContext.terminateQActorSystem(this); 
	       return false;  
	    }
	    }
	    ...
	    nPlanIter++;
	    		...
	    		if( currentMessage.msgId().equals("polar") ){
	    			...
	    			/* ActorOp */
	    			parg =  updateVars( Term.createTerm("p(Distance,Angle)"), Term.createTerm("p(Distance,SID)"), 
	    				    		  					Term.createTerm(currentMessage.msgContent()), parg);
	    			if( parg != null ){
	    				aar = solveGoalReactive(parg,3600000,"","");
	    				//println(getName() + " plan " + curPlanInExec  +  " interrupted=" + aar.getInterrupted() + " action goon="+aar.getGoon());
	    ...
	    public boolean movoToTakePhoto() throws Exception{	//public to allow reflection
	    try{
	    	curPlanInExec =  "movoToTakePhoto";
	    	boolean returnValue = suspendWork;
	    while(true){
	    nPlanIter++;
	    ...
	    return returnValue;
	       ...
	       //println( getName() + " plan=movoToTakePhoto WARNING:" + e.getMessage() );
	       QActorContext.terminateQActorSystem(this); 
	       return false;  
	    }
	    }
