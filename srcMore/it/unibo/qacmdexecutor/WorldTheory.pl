%==============================================
% WorldTheory.pl for actor qacmdexecutor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqacmdexecutor).	%%old version (deprecated)
actorobj(qatuqacmdexecutor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qacmdexecutor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qacmdexecutor" ). 
...
%-------------------------------------------------
%  User static rules about qacmdexecutor
%------------------------------------------------- 
/*
------------------------------------------------------------------------
