%==============================================
% WorldTheory.pl for actor agentprototype
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuagentprototype).	%%old version (deprecated)
actorobj(qatuagentprototype).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor agentprototype
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of agentprototype" ). 
...
%-------------------------------------------------
%  User static rules about agentprototype
%------------------------------------------------- 
/*
------------------------------------------------------------------------
