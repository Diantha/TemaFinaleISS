%==============================================
% WorldTheory.pl for actor qahello
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqahello).	%%old version (deprecated)
actorobj(qatuqahello).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qahello
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qahello" ). 
...
%-------------------------------------------------
%  User static rules about qahello
%------------------------------------------------- 
/*
------------------------------------------------------------------------
